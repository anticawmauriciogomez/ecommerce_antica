// Diccionario base construido desde los archivos de traducción del Storefront.
// Este archivo es la "fuente de verdad" para el CMS de textos del Admin.
...
export const baseDictionaryEs = {
  ...
  ReservationForm: {
    ...
    subtitle: "Asegura tu mesa en Antica.",
  ...
  Checkout: {
    ...
    documentId: "Número de Documento (NIT/Cédula)",
    address: "Dirección de envío/facturación",
...
export const baseDictionaryEn = {
  ...
  ReservationForm: {
    ...
    subtitle: "Secure your table at Antica.",
    nameLabel: "Full Name",
  ...
  Checkout: {
    ...
    name: "Full Name",
    documentId: "Document Number (NIT/Cédula)",
