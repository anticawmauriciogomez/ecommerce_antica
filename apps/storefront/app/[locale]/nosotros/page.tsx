        ...
        <div className={styles.wrapper}>
            ...
            <section className={styles.hero} style={{ backgroundImage: `url('${heroImage}')` }}>
                ...
                <div className={styles.heroContent}>
                    ...
                    <p className="text-sans">{t('heroSubtitle')}</p>
                </div>
            </section>
                         ...
                         <ScrollReveal direction="fade" delay={1600}>
                             <div className={styles.inaugurationText}>
                                 {t('sections.inauguration.text')
                                     .split('\n\n')
                                     .map((paragraph, index) => (
                                         <ScrollReveal key={index} direction="up" delay={1800 + index * 300}>
            ...
            <section className={styles.ctaSection}>
                <div className={styles.container}>
                    <h3 className="text-serif">¿Quieres ser parte de nuestra historia?</h3>
                    <p className="text-sans">Te invitamos a probar el fruto de décadas de tradición y esfuerzo.</p>
